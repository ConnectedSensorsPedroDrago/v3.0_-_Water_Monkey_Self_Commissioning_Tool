...
const Input50PercentWithTitle = ({name, setter, placeholder, type, disabled}) => {
  return (
    <div className="flex flex-col justify-start w-[49%]">
        ...
        <input 
          className={`w-full input-date-reset input-small font-normal text-sm text-dark-grey ${disabled === true && `disabled:text-grey disabled: disabled:bg-white font-semibold`}`}
