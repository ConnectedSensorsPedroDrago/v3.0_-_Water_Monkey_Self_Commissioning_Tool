...
const ModalSingleButton = ({message, action}) => {
  return (
    <div className='absolute flex flex-col items-center justify-around mb-20 w-screen h-screen bg-white bg-opacity-50 z-2000'>
        <div className='w-[95%] h-fit md:w-[35%] md:h-max bg-white bg-opacity-100 rounded shadow-lg p-4 flex flex-col items-center justify-around border-dark-grey border-[0.05rem]'>
