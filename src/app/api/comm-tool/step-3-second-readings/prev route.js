                                    ...
                                    if(data1.status === 'ok'){
                                        try{
                                            let payload = {
                                                ...
                                                // },
                                                "properties": {
                                                    "primary_pulse_volume": Number(data1.data.primary_volume_per_pulse),
                                            ...
                                            // (
                                                // payload = {
                                                    ...
                                                    // }
                                                    // "properties": {
                                                    //     "primary_pulse_volume": Number(data1.data.primary_volume_per_pulse).toFixed(3),
                                                    //     "secondary_pulse_volume": Number(data1.data.secondary_volume_per_pulse).toFixed(3),
                                                    //     "final_meter_reading_primary": Number(newLowSideSecond),
                                                    //     "final_meter_reading_secondary": Number(newHighSideSecond)
                                                    // }
                                                // }
                                            // )
                                            console.log(payload)
